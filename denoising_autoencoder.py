...
"""
 Denoising auto-encoders (dA) using Theano, based on the Deep Learning 
 tutorial.
...
def test_dA(datasets, image_width=28, image_height=28, num_classes=10, hidden_nodes=500,
    ...
    image = Image.fromarray(
        tile_raster_images(X=da.W.get_value(borrow=True).T,
                           img_shape=(image_width, image_height), tile_shape=(num_classes, num_classes),
                           tile_spacing=(1, 1)))
...
if __name__ == '__main__':
    ...
    test_dA(datasets, image_width=28, image_height=28, num_classes=10)