# -*- coding: utf-8 -*-
"""
Created on Sat May 16 09:17:03 2015
...
def run_DBN(datasets, image_width=28, image_height=28, num_classes=10, 
    ...
    dbn = DBN(numpy_rng=numpy_rng, n_ins=image_width * image_height,
